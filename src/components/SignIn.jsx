...
const Dashboard = () => {
  ...
  const filteredRecords = records.filter((e) => {
    ...
    return (
      String(e.folio).toLowerCase().includes(searchLower) ||
      (e.fecha && e.fecha.toLowerCase().includes(searchLower)) ||
      (e.dependencia && e.dependencia.toLowerCase().includes(searchLower)) ||
      (e.asunto && e.asunto.toLowerCase().includes(searchLower)) ||
      (e.estatus && e.estatus.toLowerCase().includes(searchLower))
    );
  });
