  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
    <div className="bg-gradient-to-br from-[#BC995B] to-[#ffffff] rounded-lg w-full max-w-3xl p-6 shadow-xl relative">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-[#000000]">Editar Registro</h2>
      ...
      >
        <div className="grid grid-cols-2 gap-4 mt-4">
          ...
          <div>
            <label className="block text-gray-700 font-bold">Remitente</label>
            <input
              type="text"
              className="input-field"
          ...
          <div>
            <label className="block text-gray-700 font-bold">Destinatario</label>
            <input
              type="text"
              className="input-field"
          ...
          <div>
            <label className="block text-gray-700 font-bold">Comunidad</label>
            <input
              type="text"
              className="input-field"
          ...
          <div>
            <label className="block text-gray-700 font-bold">Cargo Remitente</label>
            <input
              type="text"
              className="input-field"
          ...
          <div>
            <label className="block text-gray-700 font-bold">Cargo Destinatario</label>
            <input
              type="text"
              className="input-field"
          ...
          <div>
            <label className="block text-gray-700 font-bold">Documento</label>
            <input
              type="text"
              className="input-field"
          ...
          <div>
            ...
            <select className="input-field">
              <option value="Pendiente" selected={selectedRecord.estatus === "Pendiente"}>
                Pendiente
              </option>
              <option value="En proceso" selected={selectedRecord.estatus === "En proceso"}>
                En proceso
              </option>
              <option value="Finalizado" selected={selectedRecord.estatus === "Finalizado"}>
                Finalizado
              </option>
            </select>
          </div>
          <div>
            <label className="block text-gray-700 font-bold">Importancia</label>
            <select className="input-field">
